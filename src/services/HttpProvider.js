...
// // // // ── Messages that should never show as toasts (non-critical backend responses)
// // // const SILENT_MESSAGES = [
// // //   "user points record not found",
...
// // //   return SILENT_MESSAGES.some((m) => lower.includes(m));
// // // };
...
// // //     // Only show toast for real errors — suppress silent/not-found messages
...
//   "reward not found",
//   "invalid coupon type",        
//   "must be",                    // ✅ suppresses "Must be monthly or yearly" variant
// ];
...
const SILENT_MESSAGES = [
  ...
  "invalid sort field",
  "allowed values",
  "user id is required",   // ✅ Fixed: suppress logout-related backend error toast
];

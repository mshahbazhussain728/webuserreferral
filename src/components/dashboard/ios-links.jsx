...
export const IosLinks = ({ iosHandler }) => {
  ...
  const linksData = [
    { text: "Show Referral link",   onClick: () => handleRefLinkModal("ios")         },
    // { text: "Show Discount code",   onClick: () => handleRefDiscountCodeModal("ios") },
    { text: "Show QR code",         onClick: () => handleQRCodeModal("ios")          },
  ];
